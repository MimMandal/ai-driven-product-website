// Import custom effect component 
//Approach page dedicated for Planning & Strategy using Canvas Reveal effects cards
    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="We begin by understanding your product vision, data flow, and user intent. Using AI-driven insights, we define smart workflows, automation opportunities, and a scalable architecture tailored to your goals."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Building AI-powered features and adaptive interfaces that respond, learn, and improve over time."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="Deploying the product with continuous monitoring and improvements for better performance and experience."
        >
          <CanvasRevealEffect
            animationSpeed={3}
